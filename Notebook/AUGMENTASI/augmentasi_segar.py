...
# === KONFIGURASI FOLDER ===
input_folder = r"C:\Users\Lenovo\Klasifikasi_ikan\datasets\resized_output\segar"
output_folder = r"C:\Users\Lenovo\Klasifikasi_ikan\datasets\augmented_output\segar"
...
print(f"🔹 Kelas: Segar | Ditemukan {num_files} gambar asli.")
...
for file in files:
    ...
    for i in range(per_image_aug):
        ...
        save_path = os.path.join(output_folder, f"aug_segar_{total_generated+1:03d}.jpg")
...
print(f"✅ Total augmentasi kelas SEGAR: {total_generated} citra disimpan di {output_folder}")
